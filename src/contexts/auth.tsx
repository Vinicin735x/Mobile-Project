...
import { IAutenticate, IUserLogin} from "../services/data/User"; 
import { isAfter, parseISO} from "date-fns";
export interface IAuthContextData {
  signIn (credentials: IAutenticate): Promise<void> 
...
const signIn = useCallback(async ({ email, password }: IAutenticate) => {
